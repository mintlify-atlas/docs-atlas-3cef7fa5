...
<Steps>
  ...
  <Step title="Connect to OpenCode">
...
The [model id](/config#models) in your OpenCode config uses the format `opencode/<model-id>`. For example, for GPT 5.2 Codex, you would use `opencode/gpt-5.2-codex` in your config.
...
<CardGroup cols={2}>
  ...
  <Card title="Model Access Control" icon="toggle-on">
